...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select user_id,gate_id from tbluser where  username='$user' && password='$password' ");
    $ret = mysqli_fetch_array($query);
    var_dump($query);
    if ($ret > 0) {
        $_SESSION['uid'] = $ret['user_id'];
        $_SESSION['ugate'] = $ret['gate_id'];
                    ...
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#" style="font-size:24px;">
                                Company Visitor Management System (USER LOGIN)
                            </a>
                        </div>
