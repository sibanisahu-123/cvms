                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <?php
                            //todays visitors
                            $query = mysqli_query($con, "select ID from tblvisitor where gate=".$_SESSION['ugate']." and date(EnterDate)=CURDATE();");
                            ...
                            <div class="row m-t-25">
                                ...
                                <?php
                                //Yesterdays visitors
                                $query1 = mysqli_query($con, "select ID from tblvisitor where gate=".$_SESSION['ugate']." and date(EnterDate)=CURDATE()-1;");
                                ...
                                $query2 = mysqli_query($con, "select ID from tblvisitor where gate=".$_SESSION['ugate']." and date(EnterDate)>=(DATE(NOW()) - INTERVAL 7 DAY);");
                                ...
                                $query3 = mysqli_query($con, "select ID from tblvisitor where gate=".$_SESSION['ugate']);
