...
if (strlen($_SESSION['uid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "select user_id from tbluser where user_id='$userid' and password='$cpassword'");
        $row = mysqli_fetch_array($query);
        if ($row > 0) {
            $ret = mysqli_query($con, "update tbluser set password='$newpassword' where user_id='$userid'");
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="changepassword" onsubmit="return checkpass();">
                                                ...
                                                <?php
                                                $uid = $_SESSION['uid'];
                                                $ret = mysqli_query($con, "select * from tbluser where user_id='$uid'");
                                                $cnt = 1;
